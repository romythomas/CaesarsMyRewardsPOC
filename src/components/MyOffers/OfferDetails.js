...
const getSelectedPropertyCode = () => {
  ...
  try {
    const autocomplete_component = document.getElementById(
      "autocomplete-component"
    );
    const selectedElements = autocomplete_component.querySelectorAll(
      'li.autocomplete__item[data-selected="true"]'
    );
  ...
  render() {
    ...
    if (match.params && match.params.id) {
      ...
      if (offer && offer.length) {
        ...
        const marketsOfProperties = getMarketCodeListOfPropertyCodes(
          markets,
          propertyList
        );

        let marketPropertyListData = getStructuredMarketsPropertiesList(
          markets
        );
        marketPropertyListData = marketPropertyListData.filter((data) => {
          return (
            marketsOfProperties.includes(data.value) ||
            propertyList.includes(data.value)
          );
        });
                ...
                <div className="col-md-3 col-sm-12 pull-right">
                  <div className="details-info">
                    ...
                    <span className="expires">
                      EXPIRES:{" "}
                      <strong>{getMoment(end).format("MM/DD/YYYY")}</strong>
                    </span>
                  </div>
                </div>
                ...
                <div className="col-md-12 col-sm-12">
                  <div className="how-redeem">
                    ...
                    <div className="redeem-content">
                      <p>
                        To redeem your offer, please follow the instructions on
                        your mail piece or email. A print out of this page is
                        NOT a physical coupon and cannot be used for redemption
                        where a coupon is required and some offers require a
                        physical coupon to redeem. If this is a hotel offer and
                        you book it online; you do not need to bring in your
                        physical coupon when you check in. It is always best to
                        bring your invite or mail piece with you when you visit.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="terms">
                    ...
                    <div className="terms-content">
                      <p>
                        ...
                        casinos. Caesars Rewards Card and valid photo ID must be
                        presented upon redemption. Not responsible for lost or
                        stolen vouchers or coupons. Offers are based upon
                        availability. Effective July 1, 2017, complimentary
                        rooms booked will be subject to a $50 no-show fee, plus
                        tax if the reservation is not canceled by 6pm on the day
                        of arrival. Excludes bookings made for Caesars Windsor.
                        Additional restrictions may apply. Please see your
                        nearest Caesars Rewards Center for more details.
                      </p>
                    </div>
                  </div>
                </div>
